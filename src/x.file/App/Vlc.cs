...
namespace X.File
{
    public class VlcPlayer
    {
        ...
        {
            if (libvlc_instance_ == IntPtr.Zero || wndHandle == 0) return;
        ...
        public void LoadFile(string filePath)
        {
            ...
            if (libvlc_media == IntPtr.Zero) return;
        ...
        public void Play()
        {
            if (libvlc_media_player_ == IntPtr.Zero) return;
        ...
        public bool IsPlaying
        {
            get
            {
                var p = Duration > 0 && (int)Math.Ceiling(GetPlayTime() + 1.5) == (int)Math.Ceiling(Duration + 1.5);
                if (p) this.Stop();
                return !p;
            }
        }
